...
var page = path.split("/").pop();
	   var admin_value="";
		if(page == "live_report.php")
		{
			...
			<script type="text/javascript" src="assets/vendor/dist/js/jWebSocket.js"></script>
			<script type="text/javascript" src="assets/vendor/dist/js/techextension.js"></script>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="index.php" class="btn btn-default btn-flat">بازگشت به داشبورد</a>
                    </div>
                  </li>
                </ul>
              </li>
...
<link rel="stylesheet" type="text/css" href="assets/vendor/dist/css/csshack.css">
