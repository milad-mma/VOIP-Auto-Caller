...
<html>
  <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link rel="stylesheet" href="assets/vendor/dist/login/bootstrap.min.css">
	<link rel="stylesheet" href="assets/vendor/dist/login/fontawesome-all.min.css">
	<link rel="stylesheet" href="assets/vendor/dist/login/style.css">
	<link rel="stylesheet" href="assets/vendor/dist/login/theme.css">
  ...
  <body>
   ...
   <div class="form-body">
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    ...
                    <p>Auto Caller</p>
                    <img src="assets/vendor/dist/login/graphic5.svg" alt="">
                </div>
            </div>
                ...
                <div class="form-content">
                    <div class="form-items">
                        <div class="website-logo-inside">
                            <a href="index.php">
                                <div class="logo">
                                    <img class="logo-size" src="assets/img/brand/logo.svg" alt="">
                                </div>
                            </a>
                        </div>
						<h3>Login</h3>
    ...
    <script src="assets/vendor/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <script src="assets/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="assets/vendor/dist/login/popper.min.js"></script>
	<script src="assets/vendor/dist/login/main.js"></script>
