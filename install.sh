...
while true; do
    ...
    case $choice in
        1)
            ...
            # php-fpm رو هم ری‌استارت می‌کنیم تا OPcache نسخه‌ی قدیمی PHP رو از حافظه بندازه بیرون
            service php-fpm restart 2>/dev/null || systemctl restart php-fpm 2>/dev/null
